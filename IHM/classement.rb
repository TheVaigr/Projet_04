class Classement < Gosu::Window
  ...
  def draw
    ...
    @font2.draw(@model.meilleursJoueursScore[1,0], 240-@font2.text_width(@model.meilleursJoueursScore[1,0])/2, 360, 1)
    @font3.draw("30", 240-@font3.text_width("30")/2, 410, 1)
    @font2.draw(@model.meilleursJoueursScore[1,1], 240-@font2.text_width(@model.meilleursJoueursScore[1,1])/2, 470, 1)
    @font3.draw("30", 240-@font3.text_width("30")/2, 520, 1)
    @font2.draw(@model.meilleursJoueursScore[1,2], 240-@font2.text_width(@model.meilleursJoueursScore[1,2])/2, 580, 1)
    @font3.draw("30", 240-@font3.text_width("30")/2, 630, 1)
    @font2.draw(@model.meilleursJoueursScore[1,3], 240-@font2.text_width(@model.meilleursJoueursScore[1,3])/2, 690, 1)
    @font3.draw("30", 240-@font3.text_width("30")/2, 740, 1)
    @font2.draw(@model.meilleursJoueursScore[1,4], 240-@font2.text_width(@model.meilleursJoueursScore[1,4])/2, 800, 1)
    @font3.draw("30", 240-@font3.text_width("30")/2, 850, 1)
    # Niveau moyen
    @font4.draw("Niveau moyen", 720-@font4.text_width("Niveau moyen")/2, 250, 1)
    @font2.draw(@model.meilleursJoueursScore[2,0], 720-@font2.text_width(@model.meilleursJoueursScore[2,0])/2, 360, 1)
    @font3.draw("30", 720-@font3.text_width("30")/2, 410, 1)
    @font2.draw(@model.meilleursJoueursScore[2,1], 720-@font2.text_width(@model.meilleursJoueursScore[2,1])/2, 470, 1)
    @font3.draw(" 30", 720-@font3.text_width("30")/2, 520, 1)
    @font2.draw(@model.meilleursJoueursScore[2,2], 720-@font2.text_width(@model.meilleursJoueursScore[2,2])/2, 580, 1)
    @font3.draw("30", 720-@font3.text_width("30")/2, 630, 1)
    @font2.draw(@model.meilleursJoueursScore[2,3], 720-@font2.text_width(@model.meilleursJoueursScore[2,3])/2, 690, 1)
    @font3.draw("30", 720-@font3.text_width("30")/2, 740, 1)
    @font2.draw(@model.meilleursJoueursScore[2,4], 720-@font2.text_width(@model.meilleursJoueursScore[2,4])/2, 800, 1)
    @font3.draw("30", 720-@font3.text_width("30")/2, 850, 1)
    # Niveau difficile
    @font4.draw("Niveau difficile", 1200-@font4.text_width("Niveau difficile")/2, 250, 1)
    @font2.draw(@model.meilleursJoueursScore[3,0], 1200-@font2.text_width(@model.meilleursJoueursScore[3,0])/2, 360, 1)
    @font3.draw("30", 1200-@font3.text_width("30")/2, 410, 1)
    @font2.draw(@model.meilleursJoueursScore[3,1], 1200-@font2.text_width(@model.meilleursJoueursScore[3,1])/2, 470, 1)
    @font3.draw(" 30", 1200-@font3.text_width("30")/2, 520, 1)
    @font2.draw(@model.meilleursJoueursScore[3,2], 1200-@font2.text_width(@model.meilleursJoueursScore[3,2])/2, 580, 1)
    @font3.draw("30", 1200-@font3.text_width("30")/2, 630, 1)
    @font2.draw(@model.meilleursJoueursScore[3,3], 1200-@font2.text_width(@model.meilleursJoueursScore[3,3])/2, 690, 1)
    @font3.draw("30", 1200-@font3.text_width("30")/2, 740, 1)
    @font2.draw(@model.meilleursJoueursScore[3,4], 1200-@font2.text_width(@model.meilleursJoueursScore[3,4])/2, 800, 1)
    @font3.draw("30", 1200-@font3.text_width("30")/2, 850, 1)
    # Niveau évolutif
    @font4.draw("Niveau évolutif", 1680-@font4.text_width("Niveau évolutif")/2, 250, 1)
    @font2.draw(@model.meilleursJoueursScore[4,0], 1680-@font2.text_width(@model.meilleursJoueursScore[4,0])/2, 360, 1)
    @font3.draw("30", 1680-@font3.text_width("30")/2, 410, 1)
    @font2.draw(@model.meilleursJoueursScore[4,1], 1680-@font2.text_width(@model.meilleursJoueursScore[4,1])/2, 470, 1)
    @font3.draw(" 30", 1680-@font3.text_width("30")/2, 520, 1)
    @font2.draw(@model.meilleursJoueursScore[4,2], 1680-@font2.text_width(@model.meilleursJoueursScore[4,2])/2, 580, 1)
    @font3.draw("30", 1680-@font3.text_width("30")/2, 630, 1)
    @font2.draw(@model.meilleursJoueursScore[4,3], 1680-@font2.text_width(@model.meilleursJoueursScore[4,3])/2, 690, 1)
    @font3.draw("30", 1680-@font3.text_width("30")/2, 740, 1)
    @font2.draw(@model.meilleursJoueursScore[4,4], 1680-@font2.text_width(@model.meilleursJoueursScore[4,4])/2, 800, 1)
